...
class AppLocalizations {
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'feature_privacy_desc': 'Compete with others! Find out who tops the "Temperance Titans" and who is a legend in the "Liquid Legends". Your progress is automatically submitted to the global leaderboard.',
...
// Туториал – страница профиля
    ...
    'ru': {
      ...
      'feature_privacy_desc': 'Соревнуйся с другими пользователями! Узнай, кто возглавляет список «Героев трезвости», а кто стал легендой в «АлкоЛегендах». Твой прогресс автоматически отправляется в общий зачёт.',
