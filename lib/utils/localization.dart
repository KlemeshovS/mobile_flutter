...
//драаасте
      ...
      // Новые горы
      'ach_milestone_1917_title': 'Mt. Washington',
      'ach_milestone_1917_desc': 'Named after a president who didn\'t drink. Coincidence?',
      'ach_milestone_3491_title': 'Munku-Sardyk',
      'ach_milestone_3491_desc': 'Locals say 3491 steps of sobriety lead there. Locals lie.',
      'ach_milestone_4478_title': 'Matterhorn',
      'ach_milestone_4478_desc': 'The Swiss look at it soberly. Because watches are expensive.',
      'ach_milestone_4506_title': 'Belukha',
      'ach_milestone_4506_desc': 'Shamans don\'t drink either. Well, almost.',
      'ach_milestone_5054_title': 'Kazbek',
      'ach_milestone_5054_desc': 'Prometheus would have approved.',
      // Трезвые дни в году
      ...
      'ach_drink_year_100_desc': '100 days down. Your liver filed a formal complaint.',
      'ach_drink_year_200_title': 'Cargo 200',
      'ach_drink_year_200_desc': 'Your liver stopped writing letters home.',
      'ach_drink_year_300_title': 'Professional',
      'ach_drink_year_300_desc': '300 days. At this point it\'s basically a career.',

      'ach_sober_month_1_title': 'January Survivor',
      'ach_sober_month_1_desc': 'Sober January. Everyone else was drinking off their New Year\'s regrets.',
      'ach_sober_month_2_title': 'February Stone',
      'ach_sober_month_2_desc': 'February — sober. Even on Valentine\'s Day. Especially on Valentine\'s Day.',
      'ach_sober_month_3_title': 'Spring Monk',
      'ach_sober_month_3_desc': 'March brought flowers, sun, and zero alcohol. Suspicious.',
      'ach_sober_month_4_title': 'April Hermit',
      'ach_sober_month_4_desc': 'Spring in full bloom and you\'re sober. Nature is confused.',
      'ach_sober_month_5_title': 'BBQ Without Beer',
      'ach_sober_month_5_desc': 'May barbecues, no alcohol. Either a hero or the designated driver.',
      'ach_sober_month_6_title': 'Sober June',
      'ach_sober_month_6_desc': 'Summer started. Your liver hasn\'t heard the news yet.',
      'ach_sober_month_7_title': 'Resort Teetotaler',
      'ach_sober_month_7_desc': 'July heat, everyone\'s sipping cocktails — you\'re on water. Legend.',
      'ach_sober_month_8_title': 'August Stoic',
      'ach_sober_month_8_desc': 'Last summer month — not a drop. Iron willpower.',
      'ach_sober_month_9_title': 'Velvet Season',
      'ach_sober_month_9_desc': 'September. Everyone drowns summer sorrows. You don\'t.',
      'ach_sober_month_10_title': 'October Ghost',
      'ach_sober_month_10_desc': 'October without alcohol. Halloween wasn\'t that scary after all.',
      'ach_sober_month_11_title': 'November Hero',
      'ach_sober_month_11_desc': 'The most depressing month — sober. Not an achievement, a feat.',
      'ach_sober_month_12_title': 'New Year Stoic',
      'ach_sober_month_12_desc': 'December without alcohol. Santa took off his hat.',
...
// Подписки
    ...
    'ru': {
      ...
      'ach_milestone_1917_desc': 'Названа в честь президента, который не пил. Совпадение?',
      'ach_milestone_3491_title': 'Мунку-Сардык',
      'ach_milestone_3491_desc': 'Местные говорят, что туда ведут 3491 ступенька трезвости. Местные врут.',
      'ach_milestone_4478_title': 'Маттерхорн',
      'ach_milestone_4478_desc': 'Швейцарцы смотрят на неё трезво. Потому что часы дорогие.',
      'ach_milestone_4506_title': 'Белуха',
      'ach_milestone_4506_desc': 'Шаманы тоже не пьют. Ну почти.',
      'ach_milestone_5054_title': 'Казбек',
      'ach_milestone_5054_desc': 'Прометей оценил бы.',
      // Трезвые дни в году
      ...
      'ach_drink_year_100_desc': 'Режим соблюден, хвалим.',
      'ach_drink_year_200_title': 'Груз 200',
      'ach_drink_year_200_desc': 'Печень уже не пишет письма домой.',
      'ach_drink_year_300_title': 'Ефремыч',
      'ach_drink_year_300_desc': '300 дней. Это не привычка - это карьера.',
      ...
      'ach_sober_month_1_title': 'Выживший',
      'ach_sober_month_1_desc': 'Январь без алкоголя. Все остальные пили с горя после новогодней ночи.',
      'ach_sober_month_2_title': 'Защитник трезвости',
      'ach_sober_month_2_desc': 'Февраль прошёл без капли. Даже 23-го. Особенно 23-го.',
      'ach_sober_month_3_title': 'Цветы и минералка',
      'ach_sober_month_3_desc': 'Март — капель, солнце и ни капли алкоголя. Подозрительно.',
      'ach_sober_month_4_title': 'Первоапрельская шутка',
      'ach_sober_month_4_desc': 'Весна в разгаре, а ты трезв. Это не шутка.',
      'ach_sober_month_5_title': 'Шашлык без пива',
      'ach_sober_month_5_desc': 'Май, дача, шашлыки — и без алкоголя. Ты либо герой, либо водитель.',
      'ach_sober_month_6_title': 'Трезвый июнь',
      'ach_sober_month_6_desc': 'Лето началось, а печень ещё не знает об этом.',
      'ach_sober_month_7_title': 'Курортный трезвенник',
      'ach_sober_month_7_desc': 'Июль, жара, все с коктейлями — а ты с водой. Легенда.',
      'ach_sober_month_8_title': 'Августовский стоик',
      'ach_sober_month_8_desc': 'Последний летний месяц — и ни капли. Воля железная.',
      'ach_sober_month_9_title': 'Бархатный сезон',
      'ach_sober_month_9_desc': 'Сентябрь. Все заливают грусть по лету, ты — нет.',
      'ach_sober_month_10_title': 'Октябрьский призрак',
      'ach_sober_month_10_desc': 'Октябрь без алкоголя. Хэллоуин оказался не страшным.',
      'ach_sober_month_11_title': 'Единство с трезвостью',
      'ach_sober_month_11_desc': 'Самый депрессивный месяц — трезвый. Это не достижение, это подвиг.',
      'ach_sober_month_12_title': 'Корпоратив провален',
      'ach_sober_month_12_desc': 'Декабрь без алкоголя. Дед Мороз снял шляпу.',
