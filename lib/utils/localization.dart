...
class AppLocalizations {
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'menu_reset_subtitle':
          'If you decided to cheat yourself, then changed your mind',
      ...
      'app_origin_story_part1':
          'Wobbly was born from my own constant inner battle: am I more of an alcoholic or an athlete?',
      'app_origin_story_part2':
          'Every day presents a choice: the clear-headed high of a good workout, or the fleeting buzz of a beer. Wobbly helps you track that choice, see the truth, and ultimately discover who you want to be.',
      'about_creator_description':
          'The creator, who still doesn\'t know whether to be proud or to cry.',
      'about_capabilities_title': 'App Capabilities',
      'feature_stats_title': 'Detailed Statistics',
      'feature_stats_desc':
          'Mark the day you drink and the day you exercise (long press)',
      ...
      'feature_privacy_desc':
          'All data is stored only on your device. You can export and import it at any time.',
      'achievements_reset_notification_title': 'Achievements Reset',
      'achievements_reset_notification_message':
          'All achievements have been unlocked again based on current data',
      ...
      'status_sporty_description':
          'You prefer sneakers to wine glasses, but sometimes allow yourself a \'sports\' beer after a workout!',
      'status_alcoholic_title': 'Professional Hangover',
      'status_alcoholic_description':
          'Your liver is crying, but you stubbornly ignore its pleas. The bartender knows you by name, and the morning starts with the question "what happened yesterday?"',
      'status_boring_title': 'Boring as a Cork',
      'status_boring_description':
          'You\'ve found the perfect balance between doing nothing and pretending to do something. Master of boring perfection!',
      'status_balanced_title': 'Moderate and Boring',
      'status_balanced_description':
          'You drink just enough to not have fun, and exercise just enough to see no results. Perfect!',
      'status_moderate_drinker_title': 'Weekend Sinner',
      'status_moderate_drinker_description':
          'You drink just enough not to feel guilty, but enough to justify your existence. The art of petty sin.',
      'status_active_lifestyle_title': 'Fitness Martyr',
      'status_active_lifestyle_description':
          'You voluntarily suffer in the gym so you can suffer from a hangover with a clear conscience. The circle of torment is complete!',
      'status_weekend_warrior_title': 'Saturday Hero',
      'status_weekend_warrior_description':
          'From Monday to Friday you are a model of virtue, on Saturday you are a neighborhood legend, on Sunday you are a helpless body.',
      'status_sober_enthusiast_title': 'Sober Sadist',
      'status_sober_enthusiast_description':
          'You run from alcohol faster than from responsibility. The gym is your refuge from reality and parties.',
      'status_sports_fanatic_title': 'Slave of the Iron Temple',
      'status_sports_fanatic_description':
          'You worship iron idols, sacrificing your time, strength, and ability to walk normally the next day. Cult of pain!',
      'status_party_animal_title': 'Party Legend',
      'status_party_animal_description':
          'Your party exploits become legends, and your morning suffering becomes epic poems. Hero of Saturday night and victim of Sunday morning!',
      'status_alco_cyborg_title': 'AlcoCyborg',
      'status_alco_cyborg_description':
          'A cyborg who doesn\'t drink is just scrap metal',

      // Мотивационные фразы для алкогольных дней
      'motivation_drinking_1':
          'Your wallet isn\'t elastic. Your bank balance is at rock bottom, just like you were yesterday.',
      'motivation_drinking_2':
          'Your liver has already sent out an SOS. Maybe give it a day off?',
      'motivation_drinking_3':
          'Your liver is crying. You\'re not, because you\'re dehydrated.',
      'motivation_drinking_4':
          'Your blood alcohol level is already higher than your IQ',
      'motivation_drinking_5':
          'You\'re not drinking — the drink is drinking you. Take back the reins',
      'motivation_drinking_6':
          'Your body is already on strike. Do you want it to file for resignation?',
      'motivation_drinking_7':
          'Breakfast of Citramon and shame — is that your signature recipe? Let\'s try a new one.',
      'motivation_drinking_8':
          'You\'ve blown all your cash and your health. Congrats, you\'re the proud sponsor of your own hangover.',
      'motivation_drinking_9':
          'Wallet empty, head pounding, vision blurry. Just a regular weekend, huh?',
      'motivation_drinking_10':
          'Your morning ritual: "Where am I?", "Who am I?", "Why?". Just like a Buddhist monk, but without the enlightenment.',
      'motivation_drinking_11':
          'Your brain is already seeking political asylum in another head',
      'motivation_drinking_12':
          'You\'ve crossed every line. Even the "totally wasted" line. Welcome to the binge!',
      'motivation_drinking_13':
          'You\'re drinking away not just your money, but your face too. Soon your passport photo will be scarier than real life.',
      'motivation_drinking_14':
          'Yesterday\'s motto: "Drink to the bottom!" And you did. Even the bottom filed a complaint about you.',
      'motivation_drinking_15':
          'Yesterday you conducted a sociological study: "How people live without brains." Today it\'s time for conclusions.',
      'motivation_drinking_16':
          'Went all out again? Tomorrow your clear head will thank you. Or not.',
      'motivation_drinking_17':
          'Check out the calendar. This one\'s "totally wasted," this one\'s not. Which do you like better?',
      ...
      'motivation_sober_1':
          'You\'re not getting wasted, you\'re enjoying life. Others don\'t have the strength for that.',
      'motivation_sober_2':
          'You\'re not a loser who can\'t afford it. You\'re a king who can, but chooses not to.💪',
      'motivation_sober_3':
          'Your morning routine: waking up, not surviving. Victory.',
      'motivation_sober_4':
          'Many in your place would have cracked. But you\'re handling the pressure and the glasses.',
      'motivation_sober_5':
          'You didn\'t drink, which means tomorrow you\'ll wake up with only one pain — existential.',
      'motivation_sober_6':
          'While everyone\'s chilling in the bathroom, you\'re chilling in life. The win is obvious.',
      'motivation_sober_7':
          'You\'re not boring, you\'re sane. It\'s the new black, others just aren\'t in the loop.',
      'motivation_sober_8':
          'You have plans in the morning, they have a sentence. Feel the difference?',
      'motivation_sober_9':
          'You\'re not poisoning yourself with crap. Looks like your self-preservation instinct kicked in. Nice one.',
      'motivation_sober_10':
          'While they\'re flushing cash down the toilet, you\'re saving up for something awesome. Who\'s winning?',
      'motivation_sober_11':
          'Look at that, you\'ve got money in your wallet. Probably multiplied while you weren\'t drinking.',
      'motivation_sober_12':
          'Your calendar is clean of shame. Looks suspicious... Maybe you just forgot to mark it?',
      'motivation_sober_13':
          'You\'ve saved so much on alcohol that now you can buy yourself... one good sock. Life\'s looking up!',
      'motivation_sober_14':
          'You\'ve got a clear head and a full wallet in the morning. Looking suspiciously successful.',
      'motivation_sober_15':
          'You\'ve got an extra thousand in your pocket and extra years in reserve. What are you gonna do?',

      // Статистика – всплывающие подсказки
      'stat_sober_streak_title': 'Still not drinking?',
      'stat_sober_streak_description':
          'Every sober day is an extra wrinkle on your liver that it gratefully smooths out',
      'stat_drinking_streak_title': 'Longest drinking streak',
      'stat_drinking_streak_description':
          'Your personal record for testing liver\'s tensile strength. Let\'s keep it as a reminder.',
      'stat_max_sober_streak_title': 'Best sober streak',
      'stat_max_sober_streak_description':
          'Peak level of your adequacy. Aim for new heights while you still remember how it felt.',
      'stat_total_drinking_days_title': 'Total drinking days',
      'stat_total_drinking_days_description':
          'Counter of visited dimensions. Reminder: our dimension can be fun too.',
      'stat_total_sober_days_title': 'Total sober days',
      'stat_total_sober_days_description':
          'When you remembered going to bed. Cherish those moments of clarity!',
      'stat_drink_level_little_title': 'Light drinking days',
      'stat_drink_level_little_description':
          'Light artillery preparation before... nothing. A strange tactical move.',
      'stat_drink_level_medium_title': 'Moderate drinking days',
      'stat_drink_level_medium_description':
          'A series of successful controlled falls. The main thing is not to turn into an uncontrolled nosedive.',
      'stat_drink_level_heavy_title': 'Heavy drinking days',
      'stat_drink_level_heavy_description':
          'When you voluntarily participated in a survival experiment under conditions of severe dehydration and intoxication',
      'stat_sport_days_title': 'Workout days',
      'stat_sport_days_description':
          'Number of days when you chose sweat and endorphins over sweat and shakes. Wise choice!',
      ...
      'fact_year_full_5':
          'Liver and pancreatic cancer risk significantly reduced',
      ...
      'ach_drink_3_desc':
          'Three days in a row in the dark? Survived? You\'re a professional.',
      'ach_drink_7_title': 'Master of Morning Shame',
      'ach_drink_7_desc':
          '7 days non-stop? Your liver has already sent an SOS signal.',
      ...
      'ach_drink_30_desc':
          'You know 1001 ways to come back to life in the morning',
      ...
      'ach_sober_21_desc':
          'Bartenders cry into empty glasses when they see you',
      'ach_sober_30_title': 'King of Sober Mornings',
      'ach_sober_30_desc':
          'You remember going to bed. And getting up. And everything in between.',
      ...
      'ach_sober_90_desc':
          'You keep yourself together even when everyone else is losing their heads',
      ...
      'ach_sport_8_desc':
          'You voluntarily pay money for the right to experience pain!',
      'ach_sport_12_title': 'Fitness Maniac',
      'ach_sport_12_desc':
          'Muscle soreness has become your constant companion!',
      'ach_sport_50_title': 'Sufferer',
      'ach_sport_50_desc':
          'Your body constantly hurts somewhere, but you call it "progress"',
      'ach_sport_100_title': 'Self-Torture Guru',
      'ach_sport_100_desc':
          'Sadistic pleasure from pain has become your life\'s meaning!',
      ...
      'ach_milestone_146_desc':
          'Tens of thousands of slaves built this without water or whiskey. You just climbed it.',
      'ach_milestone_319_title': 'Chrysler Building',
      'ach_milestone_319_desc':
          'The spire is sharper than your craving for a drink.',
      'ach_milestone_443_title': 'Empire State Building',
      'ach_milestone_443_desc':
          'King Kong climbed it for a blonde. You did it for an achievement and zero drinks.',
      'ach_milestone_1234_title': 'Ai-Petri',
      'ach_milestone_1234_desc':
          'You climbed, sweated, stayed sober. The reward? A view of Yalta. Worth it?',
      'ach_milestone_4810_title': 'Mont Blanc',
      'ach_milestone_4810_desc':
          'Sport, sobriety, discipline. You made it to the top. Where\'s the champagne? Oh right, not allowed.',
      'ach_milestone_5642_title': 'Elbrus',
      'ach_milestone_5642_desc':
          'So many weeks sober, mountain lungs. Little oxygen, but a clear conscience.',
      'ach_milestone_7010_title': 'Khan Tengri',
      'ach_milestone_7010_desc':
          'Only the sky is higher. But there\'s no bar there either. At least the view\'s nice.',
      'ach_milestone_8848_title': 'Everest',
      'ach_milestone_8848_desc':
          'You\'re on top of the world. Could have just stayed sober for six months. Just kidding, well done!',

      //Ачивки для погружения
      'ach_milestone_202_negative_title': 'The Blue Hole',
      'ach_milestone_202_negative_desc':
          'Narrow, deep, dark. Just like your life after Friday.',
      'ach_milestone_1642_negative_title': 'Lake Baikal',
      'ach_milestone_1642_negative_desc':
          'The deepest freshwater lake. Your body is now fresh. And dead. И мёртвый.',
      'ach_milestone_3800_negative_title': 'The Titanic',
      'ach_milestone_3800_negative_desc':
          'Titanic\'s icy grave. And yours - in progress.',
      'ach_milestone_6066_negative_title': 'Atacama Trench',
      'ach_milestone_6066_negative_desc':
          'The Ring of Fire. Your liver is now at the epicenter too.',
      'ach_milestone_10047_negative_title': 'Kermadec Trench',
      'ach_milestone_10047_negative_desc':
          'The deep-sea robot Nereus got crushed here. But you? Tough nut.',
      'ach_milestone_11022_negative_title': 'Mariana Trench',
      'ach_milestone_11022_negative_desc':
          'You\'re at the bottom. Literally. It can\'t get worse. Or can it?',
      ...
      'review_message':
          'You\'ve spent ages filling the calendar – don\'t be a pig, drop a star at Google Play. If it sucks – hit 1 star, we\'ll fix it.',
...
// Попапы топ-3 (верх)
      ...
      'top_1_place_description':
          'You\'re on top! But remember: the higher you climb, the harder you fall.',
      'top_2_place_title': 'Silver Medalist',
      'top_2_place_description':
          'Almost there. Just a little more and you\'ll be first... or not.',
      'top_3_place_title': 'Bronze Contender',
      'top_3_place_description':
          'You\'re in the top three. Next stop — the podium.',
// Попапы дна-3 (низ)
      'bottom_1_place_title': 'Alcogodzilla',
      'bottom_1_place_description':
          'You\'re number one in the most dubious ranking. Proud?',
      'bottom_2_place_title': 'Bacchus\'s Faithful Companion',
      'bottom_2_place_description':
          'You\'re almost the champion of libations. Just a bit more',
      'bottom_3_place_title': 'Bronze Reveler',
      'bottom_3_place_description':
          'You\'re in the top three toughest alcohol tourists. Here\'s your cup, you\'ll need it.',

// Туториал – страница профиля
      'tutorial_title_profile': 'Ranking preferences',
      'tutorial_desc_profile':
          'If you want to know who’s climbing the peaks or hitting rock bottom, join the rankings!',
      'profile_guest_title': 'Not logged in',
      'profile_guest_message':
          'Sign in with Google to participate in ratings and save your progress.',
      'profile_authenticated_title': 'Your profile',
      'profile_authenticated_subtitle':
          'Manage your name and rating participation',
    ...
    'ru': {
      ...
      'app_origin_story_part1':
          'Wobbly родился из моего вечного спора с самим собой: я больше алкоголик или спортсмен?',
      'app_origin_story_part2':
          'Каждый день выбираю между кайфом от тренировки и кайфом от пива. Это приложение помогает посмотреть правде в глаза и понять, кто же ты на самом деле.',
      'about_creator_description':
          'Создатель, который сам не знает, гордиться ему или плакать',
      'about_capabilities_title': 'Возможности приложения',
      'feature_stats_title': 'Подробная статистика',
      'feature_stats_desc':
          'Отмечай день, когда ты пьешь и когда занимаешься спортом (долгое нажатие)',
      ...
      'feature_privacy_desc':
          'Все данные хранятся только на вашем устройстве. Вы можете выгружать и загружать их в любой момент.',
      'achievements_reset_notification_title': 'Ачивки сброшены',
      'achievements_reset_notification_message':
          'Все достижения разблокированы заново на основе текущих данных',
      ...
      'status_sporty_description':
          'Ты больше любишь кроссовки, чем бокалы, но иногда позволяешь себе «спортивное» пиво после тренировки!',
      'status_alcoholic_title': 'КМС по алкоспорту',
      'status_alcoholic_description':
          'Твоя печень плачет, но ты упорно не слышишь её мольбы. Бармен знает тебя по имени, а утро начинается с вопроса «что вчера было?».',
      'status_boring_title': 'Скучный как пробка',
      'status_boring_description':
          'Твоя жизнь настолько предсказуема, что даже календарь завидует. Никаких крайностей — только стабильная скука изо дня в день.',
      'status_balanced_title': 'Ровный аж тошнит',
      'status_balanced_description':
          'Ты пьёшь ровно столько, чтобы не было весело, и занимаешься спортом ровно столько, чтобы не было результата. Идеально!',
      'status_moderate_drinker_title': 'Грешник выходного дня',
      'status_moderate_drinker_description':
          'Ты пьёшь ровно столько, чтобы не чувствовать вину, но достаточно, чтобы оправдать своё существование. Искусство мелкого греха.',
      'status_active_lifestyle_title': 'Фитнес-мученик',
      'status_active_lifestyle_description':
          'Ты страдаешь в зале, чтобы потом с чистой совестью страдать от похмелья. Круг страданий замкнулся!',
      'status_weekend_warrior_title': 'Субботний герой',
      'status_weekend_warrior_description':
          'С понедельника по пятницу ты образец добродетели, в субботу — легенда района, в воскресенье — беспомощное тело.',
      'status_sober_enthusiast_title': 'Трезвый садист',
      'status_sober_enthusiast_description':
          'Ты бежишь от алкоголя быстрее, чем от ответственности. Спортзал — твоё убежище от реальности и вечеринок.',
      'status_sports_fanatic_title': 'Раб железного храма',
      'status_sports_fanatic_description':
          'Ты поклоняешься железным богам, принося им в жертву своё время, силы и возможность нормально ходить после тренировок.',
      'status_party_animal_title': 'Тусовщик-легенда',
      'status_party_animal_description':
          'Твои вечеринки войдут в историю, а твоё похмелье — в книгу рекордов. Ты не просто тусовщик, ты — легенда!',
      'status_alco_cyborg_title': 'Алкокиборг',
      'status_alco_cyborg_description':
          'Киборг, который не пьёт — просто железка.',
      ...
      // Мотивационные фразы для алкогольных дней
      'motivation_drinking_1':
          'Кошелёк не резиновый. Твой баланс на дне, как и ты после вчерашнего.',
      'motivation_drinking_2':
          'Твоя печень уже отправила SOS. Может, дашь ей выходной?',
      'motivation_drinking_3':
          'Твоя печень плачет. А ты нет, потому что обезвожен.',
      'motivation_drinking_4':
          'Твой уровень алкоголя в крови уже выше, чем твой IQ',
      'motivation_drinking_5':
          'Не ты бухаешь, а бухает тебя. Возьми бразды правления обратно.',
      'motivation_drinking_6':
          'Твой организм уже бастует. Хочешь, чтобы он подал заявление по собственному?',
      'motivation_drinking_7':
          'Завтрак из цитрамона и стыда — это твой фирменный рецепт? Давай попробуем новый.',
      'motivation_drinking_8':
          'Ты просадил все бабки и здоровье. Поздравляю, ты спонсор собственного похмелья.',
      'motivation_drinking_9':
          'Кошелёк пуст, голова болит, в глазах пелена. Нормальный выходной, чё.',
      'motivation_drinking_10':
          'Твой утренний ритуал: «где я?», «кто я?», «за что?». Прям как у буддийского монаха, только без просветления.',
      'motivation_drinking_11':
          'Твои мозги уже просят политического убежища в другой голове.',
      'motivation_drinking_12':
          'Ты перешел все границы. Даже границу «всрало». Добро пожаловать в запой!',
      'motivation_drinking_13':
          'Ты пропиваешь не только деньги, но и лицо. Скоро в паспорте будешь страшнее, чем в жизни.',
      'motivation_drinking_14':
          'Твой вчерашний девиз: «Пить до дна!». И ты допил. Даже дно пожаловалось на тебя в администрации.',
      'motivation_drinking_15':
          'Ты вчера провел социологическое исследование «Как люди живут без мозгов». Сегодня пришло время для выводов.',
      'motivation_drinking_16':
          'Снова вписались на полную? Завтра голова ясная будет благодарить. Или нет.',
      'motivation_drinking_17':
          'Зацени календарь. Вот это всрало, а это нет. Чё больше нравится?',

      // Мотивационные фразы для трезвых дней
      'motivation_sober_1':
          'Ты не бухаешь, ты кайфуешь. Остальным на это сил не хватает.',
      'motivation_sober_2':
          'Ты не лох, который не может позволить. Ты царь, который может, но не хочет.💪',
      'motivation_sober_3':
          'Твой утренний режим — проснуться, а не выжить. Победа.',
      'motivation_sober_4':
          'На твоём месте уже многие бы сломались. А ты держишь удар и стаканы.',
      'motivation_sober_5':
          'Ты не пил, а значит, завтра ты проснешься с единственной болью — экзистенциальной',
      'motivation_sober_6':
      ...
      'motivation_sober_9':
          'Ты не травишь себя всякой дрянью. Похоже, у тебя включился инстинкт самосохранения. Красава.',
      'motivation_sober_10':
          'Пока они сливают бабки в унитаз, ты копишь на что-то охуенное. Кто кого?',
      'motivation_sober_11':
          'Смотри-ка, а у тебя в кошельке завелись деньги. Наверное, размножились, пока ты не бухал.',
      'motivation_sober_12':
          'Твой календарь чист от позора. Выглядит подозрительно... Может, просто забыл отметить?',
      'motivation_sober_13':
          'Ты сэкономил на алкоголе столько, что теперь можешь купить себе... один хороший носок. Жизнь налаживается!',
      'motivation_sober_14':
          'У тебя с утра ясная голова и полный кошелёк. Выглядишь подозрительно успешным.',
      'motivation_sober_15':
          'Тебя ждёт лишняя тысяча в кармане и лишние годы в запасе. Чё будешь делать?',

      // Статистика – всплывающие подсказки
      'stat_sober_streak_title': 'Все еще не пьешь?',
      'stat_sober_streak_description':
          'Каждый день без алкоголя — это лишняя складка на твоей печени, которую она с благодарностью разглаживает',
      'stat_drinking_streak_title': 'Максимальная серия с алкоголем',
      'stat_drinking_streak_description':
          'Твой личный рекорд по проверке прочности печени на разрыв. Давай оставим его как напоминание.',
      'stat_max_sober_streak_title': 'Лучшая серия трезвости',
      'stat_max_sober_streak_description':
          'Пиковое значение твоей адекватности. Стремись к новым высотам, пока помнишь, как это было.',
      'stat_total_drinking_days_title': 'Всего дней с алкоголем',
      'stat_total_drinking_days_description':
          'Счётчик посещённых измерений. Напоминание: в нашем измерении тоже бывает весело.',
      'stat_total_sober_days_title': 'Всего дней без алкоголя',
      'stat_total_sober_days_description':
          'Когда ты помнил, как лег спать. Цени эти моменты ясности!',
      'stat_drink_level_little_title': 'Дни когда выпил немного',
      'stat_drink_level_little_description':
          'Лёгкая артподготовка перед... ничем. Странный тактический ход.',
      'stat_drink_level_medium_title': 'Дни с умеренным употреблением',
      'stat_drink_level_medium_description':
          'Серия успешных контролируемых падений. Главное — не перейти в неконтролируемое пике.',
      'stat_drink_level_heavy_title': 'Дни с сильным употреблением',
      'stat_drink_level_heavy_description':
          'Когда ты добровольно становился участником эксперимента по выживанию в условиях жесточайшего обезвоживания и интоксикации',
      'stat_sport_days_title': 'Дни занятий спортом',
      'stat_sport_days_description':
          'Количество дней, когда ты выбрал пот и эндорфины вместо пота и дрожи. Мудрый выбор!',
      ...
      'fact_2m_full_5':
          'Снижается тревожность и улучшается психическое здоровье',
      ...
      'ach_drink_7_desc':
          '7 дней без передышки? Твоя печень уже подала сигнал SOS.',
      ...
      'ach_sober_30_desc':
          'Ты помнишь, как лег спать. И как встали. И всё между.',
      ...
      'ach_sober_90_desc':
          'Ты держишь себя в руках, даже когда все вокруг теряют головы',
      ...
      'ach_sport_8_desc':
          'Ты добровольно платишь деньги за право испытывать боль!',
      'ach_sport_12_title': 'Фитнес-маньяк',
      'ach_sport_12_desc': 'Крепатура стала твоим постоянным спутником!',
      'ach_sport_50_title': 'Страдалец',
      'ach_sport_50_desc':
          'Твое тело постоянно где-то болит, но ты называешь это "прогрессом"!',
      'ach_sport_100_title': 'Гуру самоистязания',
      'ach_sport_100_desc':
          'Садистское удовольствие от боли стало твоим смыслом жизни!',
      ...
      'ach_milestone_146_desc':
          'Десятки тысяч рабов строили это без воды и виски. А ты просто поднялся.',
      ...
      'ach_milestone_443_desc':
          'Кинг-Конг карабкался сюда ради красотки. А ты — ради ачивки и без выпивки.',
      'ach_milestone_1234_title': 'Ай-Петри',
      'ach_milestone_1234_desc':
          'Поднимался, потел, не пил. Итог — вид на Ялту. Оно того стоило?',
      'ach_milestone_4810_title': 'Монблан',
      'ach_milestone_4810_desc':
          'Спорт, трезвость, дисциплина. И вот ты на вершине. Где шампанское? А, нельзя.',
      'ach_milestone_5642_title': 'Эльбрус',
      'ach_milestone_5642_desc':
          'Столько недель без алкоголя. Кислорода мало, зато совесть чиста.',
      'ach_milestone_7010_title': 'Хан Тенгри',
      'ach_milestone_7010_desc':
          'Выше только небо. Но там тоже нет бара. Зато есть вид.',
      'ach_milestone_8848_title': 'Эверест',
      'ach_milestone_8848_desc':
          'Ты на крыше мира. Обратный билет — пешком. Главное, не расслабляйся.',

      //Ачивки для погружения
      'ach_milestone_202_negative_title': 'Голубая дыра',
      'ach_milestone_202_negative_desc':
          'Узкая, глубокая, тёмная. Как твоя жизнь после пятницы.',
      'ach_milestone_1642_negative_title': 'Байкал',
      'ach_milestone_1642_negative_desc':
          'Самое глубокое пресное озеро. Твой организм теперь тоже пресный. И мёртвый.',
      'ach_milestone_3800_negative_title': 'Титаник',
      'ach_milestone_3800_negative_desc':
          'Ледяная могила Титаника. И твоя - в процессе.',
      'ach_milestone_6066_negative_title': 'Атакамская впадина',
      'ach_milestone_6066_negative_desc':
          'Огненный пояс Земли. Твоя печень сейчас тоже в эпицентре.',
      'ach_milestone_10047_negative_title': 'Кермадек',
      'ach_milestone_10047_negative_desc':
          'Здесь раздавило глубоководного «Нерея». А ты - ничего, крепкий орешек.',
      'ach_milestone_11022_negative_title': 'Марианская впадина',
      'ach_milestone_11022_negative_desc':
          'Ты на дне. Буквально. Хуже уже не будет. Или будет?',
      ...
      'review_message':
          'Потратил кучу времени на заполнение календаря – не будь свиньёй, поставь звёздочку в Google Play. А если бесит – стукни единицу, я исправлюсь.',
      ...
      'error_username_invalid_characters':
          'Разрешены латинские буквы, цифры, подчеркивания и дефисы.',
      ...
      'top_1_place_description':
          'Ты на вершине! Но помни: чем выше, тем больнее падать.',
      'top_2_place_title': 'Серебряный призер',
      'top_2_place_description':
          'Почти у цели. Ещё чуть-чуть и ты станешь первым... или нет.',
      'top_3_place_title': 'Бронзовые боец',
      'top_3_place_description': 'Ты в тройке лидеров. Поднажми.',
      'bottom_1_place_title': 'Алкогодзилла!',
      'bottom_1_place_description':
          'Ты - номер один в самом сомнительном рейтинге. Гордишься?',
      'bottom_2_place_title': 'Верный соратник Бахуса',
      'bottom_2_place_description':
          'Ты почти чемпион по возлияниям. Остановись.',
      'bottom_3_place_title': 'Бронзовый гуляка',
      'bottom_3_place_description':
          'Ты в тройке самых стойких алкотуристов. Держи кубок, он тебе пригодится.',

      // Туториал – страница профиля
      'tutorial_title_profile': 'Участвуй в рейтингах!',
      'tutorial_desc_profile':
          'Хочешь знать, кто круче покоряет вершины, а кто сильнее погружается на дно? Участвуй в рейтингах!',
  ...
  String get tutorialStartSufferingButton =>
      translate('tutorial_start_suffering_button');
...
// Геттеры для stats_screen.dart
  ...
  String get statSoberStreakDescription =>
      translate('stat_sober_streak_description');
  String get statDrinkingStreakTitle => translate('stat_drinking_streak_title');
  String get statDrinkingStreakDescription =>
      translate('stat_drinking_streak_description');
  String get statMaxSoberStreakTitle =>
      translate('stat_max_sober_streak_title');
  String get statMaxSoberStreakDescription =>
      translate('stat_max_sober_streak_description');
  String get statTotalDrinkingDaysTitle =>
      translate('stat_total_drinking_days_title');
  String get statTotalDrinkingDaysDescription =>
      translate('stat_total_drinking_days_description');
  String get statTotalSoberDaysTitle =>
      translate('stat_total_sober_days_title');
  String get statTotalSoberDaysDescription =>
      translate('stat_total_sober_days_description');
  String get statLittleTitle => translate('stat_drink_level_little_title');
  String get statLittleDescription =>
      translate('stat_drink_level_little_description');
  String get statMediumTitle => translate('stat_drink_level_medium_title');
  String get statMediumDescription =>
      translate('stat_drink_level_medium_description');
  String get statHeavyTitle => translate('stat_drink_level_heavy_title');
  String get statHeavyDescription =>
      translate('stat_drink_level_heavy_description');
  String get statSportDaysTitle => translate('stat_sport_days_title');
  String get statSportDaysDescription =>
      translate('stat_sport_days_description');
  ...
  String get featureAchievementsTitle =>
      translate('feature_achievements_title');
  ...
  String get achievementsResetNotificationTitle =>
      translate('achievements_reset_notification_title');
  String get achievementsResetNotificationMessage =>
      translate('achievements_reset_notification_message');
